...
class MdbMongodbClusterHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] shard_name: The name of the shard to which the host belongs.
        :param pulumi.Input[str] type: type of mongo daemon which runs on this host (mongod, mongos or monogcfg). Defaults to mongod.
        """
        pulumi.set(__self__, "subnet_id", subnet_id)
        pulumi.set(__self__, "zone_id", zone_id)
        if assign_public_ip is not None:
...
class MdbPostgresqlClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MdbPostgresqlClusterConfigPerformanceDiagnosticsArgs'] performance_diagnostics: Cluster performance diagnostics settings. The structure is documented below. [YC Documentation](https://cloud.yandex.com/docs/managed-postgresql/grpc/cluster_service#PerformanceDiagnostics)
...
class MdbPostgresqlClusterConfigAccessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[bool] data_lens: Allow access for [Yandex DataLens](https://cloud.yandex.com/services/datalens).
        :param pulumi.Input[bool] web_sql: Allows access for [SQL queries in the management console](https://cloud.yandex.com/docs/managed-postgresql/operations/web-sql-query)
        """
        if data_lens is not None:
            pulumi.set(__self__, "data_lens", data_lens)
        if web_sql is not None:
...
class MdbPostgresqlClusterDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] owner: Name of the user assigned as the owner of the database.
        :param pulumi.Input[Sequence[pulumi.Input['MdbPostgresqlClusterDatabaseExtensionArgs']]] extensions: Set of database extensions. The structure is documented below
...
class MdbPostgresqlClusterHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] replication_source_name: Host replication source name, case when not set then host shuld be in HA group. It works only when `name` is set.
        :param pulumi.Input[str] subnet_id: The ID of the subnet, to which the host belongs. The subnet must be a part of the network to which the cluster belongs.
        """
        pulumi.set(__self__, "zone", zone)
        if assign_public_ip is not None:
...
class MdbPostgresqlClusterUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MdbPostgresqlClusterUserPermissionArgs']]] permissions: Set of permissions granted to the user. The structure is documented below.
